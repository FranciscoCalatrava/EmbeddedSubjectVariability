...
class Trainer_Step_2():
    ...
    def train(self, epochs):
        ...
        for a in range(epochs):
            ...
            print(f"||Validation|| Acc: {accuracy_validation} || Loss: {avg_loss_validation} ||")
            early_stopping(accuracy_validation['discriminator'], self.classifier)
...
if __name__ == "__main__":
    ...
    path_encoder = MLSP_DATA_ROOT + f"/models/MLSP2025/{input_parameters['dataset']}/{input_parameters['experiment']}/{input_parameters['seed']}/step_1/encoder.pt"
    path_decoder = MLSP_DATA_ROOT + f"/models/MLSP2025/{input_parameters['dataset']}/{input_parameters['experiment']}/{input_parameters['seed']}/step_1/decoder.pt"
    ...
    path = MLSP_DATA_ROOT + f'/models/MLSP2025/{input_parameters["dataset"]}/{input_parameters["experiment"]}/{input_parameters["seed"]}/step_2/'
