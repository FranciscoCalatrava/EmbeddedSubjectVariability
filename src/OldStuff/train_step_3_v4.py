...
class Trainer_3():
    ...
    def train(self, epochs, dataset_type):
        ...
        early_stopping = EarlyStopping(patience=4, verbose=True, path='model_checkpoint.pt')
        for a in range(epochs):
            ...
            if a%1 == 0:
                ...
                if len(buffer_values) > 80 and accuracy_classifier['classifier'] > threshold and accuracy_discriminator['discriminator'] < 0.6:
                    early_stopping(accuracy_classifier['classifier'], self.classifier)
...
if __name__ == "__main__":
    ...
    path = f'/Percom2024/{input_parameters["dataset"]}/{input_parameters["experiment"]}/{input_parameters["seed"]}/step_3/'
